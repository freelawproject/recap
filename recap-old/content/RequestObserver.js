...
RequestObserver.prototype = {
	...
	// Strip out filename, returns:
	//  86147-0-_LM.pdf
	
	var matches = URIpath.match(/file=((.*)\.pdf)/i);
    ...
    isCacheworthy: function(channel) {
        var ctype = "";
        try {
	    ctype = channel.getResponseHeader("Content-Type");
	} catch(e) {
	...
	if (this.isCacheworthy(channel)) {
	    log("cacheworthy page");

	    // TK: call parseFilename instead for actual PACER domain
